...
function Technical() {
    return (
        <div id="technical">
            <h1 className="technical-header"><span>Technical Skills</span></h1>
            ...
            <div className="techno">
                ...
                <div className="t2">
                    <h2 className="tech-header2">Full Stack Development<br></br><br></br><br></br>MERN</h2>
                    <p className="tech-header3">
                ...
                <div className="t2">
                    <h2 className="tech-header2">Video Editing<br></br><br></br><br></br>Vegas Pro</h2>
                    <p className="tech-header3">
